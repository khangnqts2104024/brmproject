...
//    private Integer categoryId;
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(title, that.title) && Objects.equals(author, that.author) && Objects.equals(preview, that.preview) && Objects.equals(pricePerDay, that.pricePerDay) && Objects.equals(photo, that.photo) && Objects.equals(bookshelfId, that.bookshelfId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, title, author, preview, pricePerDay, photo, bookshelfId);
    }
